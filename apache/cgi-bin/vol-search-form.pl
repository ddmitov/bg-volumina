...
$label_title_main = $label_bg_title_main;
...
$label_case_off = $label_bg_case_off;
$label_case_on = $label_bg_case_on;
...
$label_search_form = $label_bg_search_form;
...
$label_title_main = $label_en_title_main;
...
$label_case_off = $label_en_case_off;
$label_case_on = $label_en_case_on;
...
$label_search_form = $label_en_search_form;
...
$default_label_case = $label_case_off;
...
if ($out eq 'file'){$program_name = 'vol-srchdmp.pl'};
if ($out eq 'screen'){$program_name = 'vol-search.pl'};

# Defining form values:
if ($case eq ''){$value_case = $default_value_case}else{$value_case = $case}
...
if ($case eq ''){$label_case = $default_label_case}
...
if ($case eq 'off'){$label_case = $label_case_off}
if ($case eq 'on'){$label_case = $label_case_on}
...
print "        <font face='Times New Roman' size=4><b>$label_title_main</b></font>\n";
print "      </td>\n";
print "    </tr>\n";
...
print "        <font face='Verdana' size='2'><b>$label_author</b></font>\n";
print "      </td>\n";

print "      <!-- Row 3 Column 2 -->\n";
print "      <td align='center'>\n";
print "        <font face='Verdana' size='2'><b>$label_title</b></font>\n";
print "      </td>\n";
print "    </tr>\n";
...
print "      <td  align='center'>\n";
print "        <input class='aceTextField' type='text' name='AUTHOR' size='40' maxlength='40' value='$AUTHOR'>\n";
print "      </td>\n";

print "      <!-- Row 4 Column 2 -->\n";
print "      <td align='center'>\n";
print "        <input class='aceTextField' type='text' name='TITLE' size='40' maxlength='40' value='$TITLE'>\n";
print "      </td>\n";
print "    </tr>\n";

print "    <tr>\n";
print "      <!-- Row 5 Column 1 -->\n";
print "      <td align='center'>\n";
print "        <font face='Verdana' size='2'><b>$label_place</b></font>\n";
print "      </td>\n";

print "      <!-- Row 5 Column 2 -->\n";
print "      <td align='center'>\n";
print "        <font face='Verdana' size='2'><b>$label_journal</b></font>\n";
print "      </td>\n";
print "    </tr>\n";

print "    <tr>\n";
print "      <!-- Row 6 Column 1 -->\n";
print "      <td align='center'>\n";
print "        <input class='aceTextField' type='text' name='PLACE' size='40' maxlength='40' value='$PLACE'>\n";
print "      </td>\n";

print "      <!-- Row 6 Column 2 -->\n";
print "      <td align='center'>\n";
print "        <input class='aceTextField' type='text' name='JOURNAL' size='40' maxlength='40' value='$JOURNAL'><br>\n";
print "      </td>\n";
print "    </tr>\n";

print "    <tr>\n";
print "      <!-- Row 7 Column 1 -->\n";
if ($out eq 'screen'){print "<td align='center'>\n"}
if ($out eq 'file'){print "<td align='center' colspan=2>\n"}
print "        <select name='case' size=1>\n";
print "        <option value='$value_case'>&nbsp $label_case &nbsp</option>\n";
if ($label_case ne $label_case_off){print "<option value='off'>&nbsp $label_case_off &nbsp</option>\n"}
if ($label_case ne $label_case_on){print "<option value='on'>&nbsp $label_case_on &nbsp</option>\n"}
print "        </select>\n";
print "      </td>\n";

if ($out eq 'screen'){
print "      <!-- Row 7 Column 2 -->\n";
print "      <td align='center'>\n";
...
print "      <!-- Row 2 -->\n";
print "      <td align='center'>\n";
print "          <input class='aceButton' type='submit' value='&nbsp &nbsp $label_search_form &nbsp &nbsp'>\n";
print "      </td>\n";
print "    </tr>\n";
...
print "          <A class=menu href='../index_$lang.htm#search'>&nbsp $label_back &nbsp</A>\n";
print "          &nbsp\n";
print "          <A class=menu href='/cgi-bin/$search_form_script?lang=$lang&out=$out'>&nbsp $label_reset &nbsp</A>\n";
print "          </DIV>\n";
print "      </td>\n";
print "    </tr>\n";
